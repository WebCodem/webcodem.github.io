        ...
        function sendMessage() {
            ...
            if (message.trim() !== "") {
                ...
                botMessageContainer.innerHTML += '<p class="system-message">Preguntas frecuentes' + systemResponse + '</p>'
        ...
        function showAdditionalInfo(option) {
            ...
            if (option === 1) {
                ...
                additionalInfo.innerHTML = "Puedes jugar juegos que aún no han salido en la página de funciones en este <a href='./funciones/juego-1'>enlace</a> Estos juegos pueden tener bugs o fallos dentro del juego, por eso te recomendamos reportar cada bug o fallo en la pestaña de reportar bugs o fallos. Recuerda que estaremos atendiendo las 24 horas del día.";
            }
