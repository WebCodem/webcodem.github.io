        ...
        function showAdditionalInfo(option) {
            ...
            if (option === 1) {
                additionalInfo.innerHTML = "¿Quieres hablar con soporte en vivo? Entra a este <a href='./soporte'>enlace</a> para ser atendido por el soporte en línea en las 24 horas del día.";
            } else if (option === 2) {
