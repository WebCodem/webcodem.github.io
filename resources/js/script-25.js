        ...
        function lenguaje(texto) {
            ...
            var respuestas = {
                ...
                "me siento mal": ["Lamento escuchar eso. ¿Hay algo en particular que esté contribuyendo a cómo te sientes?", "A veces, expresar cómo te sientes puede ayudar a aliviar parte de la carga emocional.", "Recuerda que está bien pedir ayuda cuando te sientes mal. ¿Hay alguien con quien te sientas cómodo hablando sobre esto?"],
    "tengo problemas para dormir": ["Lo siento por escuchar eso. ¿Has probado alguna técnica de relajación antes de acostarte?", "La calidad del sueño es importante para tu bienestar. ¿Hay algo que pueda estar afectando tu sueño?", "A veces, establecer una rutina de sueño regular puede ayudar a mejorar la calidad del sueño."],
    "me siento abrumado por la presión": ["La presión puede ser difícil de manejar. ¿Hay algo específico que esté contribuyendo a esa presión?", "Recuerda que es importante cuidar de ti mismo y establecer límites saludables.", "¿Hay alguna manera en que pueda ayudarte a manejar la presión que estás sintiendo?"],
    "me preocupa el futuro": ["Preocuparse por el futuro es algo común. ¿Hay algo en particular que te preocupe?", "A veces, centrarse en el presente y tomar las cosas un paso a la vez puede ayudar a reducir la ansiedad sobre el futuro.", "Recuerda que el futuro es incierto y está bien sentirse preocupado, pero también es importante mantener una perspectiva positiva."],
    "siento que no soy lo suficientemente bueno": ["Es normal tener momentos de duda sobre uno mismo. ¿Qué te hace sentir así?", "Recuerda que tus pensamientos y sentimientos no siempre reflejan la realidad. Eres valioso y capaz.", "La autoaceptación y el autocuidado son importantes para cultivar una buena autoestima. ¿Hay algo que puedas hacer para cuidarte a ti mismo?"],
    "tengo estrés": ["Lamento escuchar eso. ¿Hay algo específico que esté causando tu estrés?", "El estrés puede ser abrumador, ¿has probado alguna técnica de relajación?", "Recuerda tomarte un tiempo para ti mismo y cuidar tu bienestar."],
    "me siento abrumado": ["Te entiendo, sentirse abrumado puede ser difícil de manejar.", "¿Hay algo en particular que esté contribuyendo a esa sensación de abrumamiento?", "A veces, dividir las tareas en partes más pequeñas puede ayudar a manejar la sensación de abrumamiento."],
    "no sé qué hacer con mi vida": ["Es normal sentirse perdido a veces. ¿Hay algo que te interese o te apasione?", "Explorar tus intereses y valores puede ayudarte a encontrar un camino que sea significativo para ti.", "¿Te gustaría hablar sobre tus metas y cómo alcanzarlas?"],
    "me siento inseguro": ["La inseguridad es algo que muchas personas experimentan en ciertos momentos. ¿Qué te hace sentir inseguro?", "Recuerda que eres capaz y valioso, a pesar de cualquier inseguridad que puedas sentir.", "A veces, enfrentar tus miedos puede ayudar a reducir la sensación de inseguridad."],
    "tengo ansiedad": ["Lo siento mucho por lo que estás pasando.", "¿Hay algo en particular que desencadene tu ansiedad?", "¿Has considerado hablar con un profesional sobre esto?"],
    "me siento solo": ["Te escucho, y estoy aquí para ti.", "A veces, sentirse solo puede ser abrumador. ¿Hay algo que puedas hacer para conectarte con otras personas?", "Recuerda que no estás solo, siempre hay personas dispuestas a escucharte."],
    "estoy deprimido": ["Lamento escuchar eso. ¿Has considerado buscar ayuda profesional?", "La depresión puede ser muy difícil de enfrentar solo. ¿Te gustaría hablar más al respecto?", "Es importante que cuides de ti mismo. ¿Hay algo que te haga sentir un poco mejor?"],
   "me siento suicidar": ["Es crucial buscar ayuda de inmediato. Por favor, considera comunicarte con un ser querido o llamar a una línea de ayuda de emergencia. Tu vida es valiosa y hay personas dispuestas a apoyarte.", "Recuerda que no estás solo en esto. Hablar con un profesional de la salud mental puede proporcionarte el apoyo y la orientación que necesitas para superar estos sentimientos.", "Estoy aquí para ti y quiero que sepas que hay esperanza y ayuda disponible para ti. Por favor, busca ayuda de inmediato."],
    "me siento atrapado": ["Entiendo cómo te sientes. ¿Qué te hace sentir atrapado?", "A veces, hablar sobre lo que te está haciendo sentir atrapado puede ayudar a encontrar soluciones.", "Recuerda que siempre hay opciones disponibles, incluso si no las ves en este momento."],
    "estoy experimentando ataques de pánico": ["Lo siento mucho por lo que estás experimentando. ¿Has experimentado esto antes?", "Respirar lenta y profundamente puede ayudar a calmar los ataques de pánico. ¿Has intentado alguna técnica de respiración?", "Buscar ayuda profesional puede ser útil para aprender a manejar los ataques de pánico."],
    "me siento agobiado por las responsabilidades": ["Es comprensible sentirse abrumado por las responsabilidades. ¿Hay algo específico que esté causando esa sensación de agobio?", "A veces, delegar tareas o establecer prioridades puede ayudar a manejar la carga de responsabilidades.", "Recuerda que está bien pedir ayuda cuando te sientes abrumado."],
    "no puedo concentrarme": ["La falta de concentración puede ser difícil de manejar. ¿Has intentado establecer un horario o un ambiente de trabajo más tranquilo?", "Tomar descansos regulares y practicar la atención plena pueden ayudar a mejorar la concentración. ¿Has probado alguna de estas técnicas?", "Recuerda que es importante ser amable contigo mismo cuando te resulta difícil concentrarte."],
  "solo quiero matar": ["Es preocupante escuchar eso. Tu bienestar es importante y hay formas de ayudarte a superar estos sentimientos. Te animo a hablar con alguien en quien confíes o buscar ayuda profesional. Si necesitas apoyo inmediato, considera llamar a una línea de ayuda de emergencia. Siempre hay personas dispuestas a escucharte y ayudarte."],
