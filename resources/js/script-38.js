        document.getElementById("question-form").addEventListener("submit", function(event) {
            ...
            sendToDiscord(name, question, pregunta1, pregunta2, pregunta3, pregunta4, pregunta5, pregunta6);
        });

        function sendToDiscord(name, question, pregunta1, pregunta2, pregunta3, pregunta4, pregunta5, pregunta6) {
